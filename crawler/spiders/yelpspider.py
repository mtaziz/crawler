...
from crawler.items import YelpReview
...
_ALLOW_SEARCH_STR = r'/search\?find_loc={0}%2C\+WA&cflt=restaurants(&start=\d+)?$'
_DENY_SEARCH_STR = r'/search\?find_loc={0}%2C\+WA&cflt=restaurants&start=0$'
